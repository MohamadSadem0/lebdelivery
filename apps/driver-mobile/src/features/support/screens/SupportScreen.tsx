...
export function SupportScreen() {
  ...
  const ticketsQuery = useQuery({ queryKey: ['driver-support-tickets'], queryFn: getSupportTickets });
  const createMutation = useMutation({
    mutationFn: createSupportTicket,
    onSuccess: async () => {
      setSubject('');
      setDescription('');
      await queryClient.invalidateQueries({ queryKey: ['driver-support-tickets'] });
    }
  });
    ...
    <Screen>
      ...
      <View style={styles.form}>
        ...
        <TextInput
          ...
          placeholder="Describe the delivery or cash issue"
          multiline
        />
